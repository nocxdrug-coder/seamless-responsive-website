...
type Module = typeof import("../admin-legacy-hidden-login-redirect.js")

type Info = GetInfo<{
  file: "routes/admin-legacy-hidden-login-redirect.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../admin-legacy-hidden-login-redirect.js");
}];
