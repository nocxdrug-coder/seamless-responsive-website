...
type Module = typeof import("../admin-legacy-panel-entry-redirect.js")

type Info = GetInfo<{
  file: "routes/admin-legacy-panel-entry-redirect.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../admin-legacy-panel-entry-redirect.js");
}];
